...
import xyz.jerez.se.jmx.bean.HelloMBean;
...
public class RmiClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ObjectName mbeanName = new ObjectName("xyz.jerez.se.jmx.bean:name=hello");
        ...
        mbsc.setAttribute(mbeanName, new Attribute("Age", 25));
        int age = (int) mbsc.getAttribute(mbeanName, "Age");
